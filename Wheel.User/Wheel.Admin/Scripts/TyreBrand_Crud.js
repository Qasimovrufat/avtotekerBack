                ...
                actions: {
                    listAction: function(postData, jtParams) {
                        return $.Deferred(function($dfd) {
                            $.ajax({
                                url: '/tyrebrand/TyreBrandList?jtStartIndex=' + jtParams.jtStartIndex + '&jtPageSize=' + jtParams.jtPageSize,
                                type: 'get',
                                dataType: 'json',
                                data: postData,
                        ...
                        return $.Deferred(function($dfd) {
                            $.ajax({
                                ...
                                success: function(data) {
                                    $dfd.resolve(data);
                                    var message =
                                        "<a href='#' class='notify-action'>Clear</a> Tyre Brand added succesfuly";
                                    var status = "success";
                                    var pos = "top-right";
                        ...
                        return $.Deferred(function($dfd) {
                            $.ajax({
                                ...
                                success: function(data) {
                                    $dfd.resolve(data);
                                    var message =
                                        "<a href='#' class='notify-action'>Clear</a> Tyre Brand Updated succesfuly";
                                    var status = "success";
                                    var pos = "top-right";
                                    showNotification(message, status, pos);
