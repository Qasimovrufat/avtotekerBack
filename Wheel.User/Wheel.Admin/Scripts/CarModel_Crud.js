$(function () {
    ...
    init: function () {
        var cachedCarOptions = null;
        $("#students_crud")
            .jtable({
                title: "The Car Model List",
                paging: true,
                pageSize: 10,
                sorting: false,
                multiSorting: true,
                ...
                deleteConfirmation: function (t) {
                    t.deleteConfirmMessage = "Are you sure to delete Car Model " + t.record.Name + "?";
                },
                ...
                actions: {
                    listAction: function(postData, jtParams) {
                        return $.Deferred(function($dfd) {
                            $.ajax({
                                url: '/CarModel/CarModelList?jtStartIndex=' + jtParams.jtStartIndex + '&jtPageSize=' + jtParams.jtPageSize,
                                type: 'get',
                                dataType: 'json',
                                data: postData,
                ...
                fields: {
                    ...
                    CarId: {
                        ...
                        options: function () {
                            ...
                            if (cachedCarOptions) { //Check for cache
                                return cachedCarOptions;
                            }

                            var options = [];

                            $.ajax({ //Not found in cache, get from server
                                url: '/CarModel/GetCarOptions',
                                type: 'POST',
                                dataType: 'json',
                                async: false,
                                success: function (data) {
                            ...
                            return cachedCarOptions = options; //Cache results and return options
                        }
                    },
                    Name: {
                        title: "Name",
