$(function() {
    ...
    altair_tablesorter.pager_filter_example(), altair_tablesorter.align_widget_example(), altair_tablesorter.custom_filters()
}), altair_tablesorter = {
    pager_filter_example: function() {
        function e() {
            selectizeObj = $("select.ts_gotoPage").val($("select.ts_gotoPage option:selected").val()).after('<div class="selectize_fix"></div>').selectize({
                hideSelected: !0,
        ...
        $.tablesorter.language.button_print = "Print table", $.tablesorter.language.button_close = "Cancel", $("#printTable").on("click", function(e) {
            e.preventDefault(), t.trigger("printTable")
        });
        var a = t.tablesorter({
            theme: "altair",
            widthFixed: !0,
            ...
            widgetOptions: {
                ...
                print_styleSheet: "",
                print_now: !0,
                print_callback: function(e, t, i) {
                    altair_main_sidebar.hide_sidebar(), setTimeout(function() {
                        $.tablesorter.printTable.printOutput(e, t.html(), i)
                    }, 300)
                }
            }
        ...
        i.children("li").each(function(e) {
            var t = $(this),
                i = 0 == e ? "auto" : e;
            t.children("input").attr("id", "column_" + i), t.children("label").attr("for", "column_" + i), t.children("input").prop("checked", !0).iCheck({
                checkboxClass: "icheckbox_md",
                radioClass: "iradio_md",
                increaseArea: "20%"
            }), 0 != e && t.find("input").on("ifChanged", function(e) {
                $(e.target).toggleClass("checked").change()
            })
        }), $("#column_auto").on("ifChecked", function(e) {
            $(this).closest("li").siblings("li").find("input").iCheck("disable"), $(e.target).removeClass("checked").change()
        }).on("ifUnchecked", function(e) {
            $(this).closest("li").siblings("li").find("input").iCheck("enable"), $(e.target).addClass("checked").change()
        }), e(), $(".pagesize.ts_selectize").after('<div class="selectize_fix"></div>').selectize({
            hideSelected: !0,
            onDropdownOpen: function(e) {
                e.hide().velocity("slideDown", {
                    duration: 200,
            ...
            t.find(".ts_checkbox").prop("checked", !0).iCheck("update").closest("tr").addClass("row_highlighted")
        }).on("ifUnchecked", function() {
            t.find(".ts_checkbox").prop("checked", !1).iCheck("update").closest("tr").removeClass("row_highlighted")
        }), t.find(".ts_checkbox").on("ifUnchecked", function() {
            $(this).closest("tr").removeClass("row_highlighted"), $(".ts_checkbox_all").prop("checked", !1).iCheck("update")
        }).on("ifChecked", function() {
