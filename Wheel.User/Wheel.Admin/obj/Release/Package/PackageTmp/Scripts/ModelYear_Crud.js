        ...
        $("#students_crud")
            .jtable({
                ...
                deleteConfirmation: function(t) {
                    t.deleteConfirmMessage = "Are you sure to delete Model-Year " + t.record.Name + "?";
                },
                        ...
                        return $.Deferred(function($dfd) {
                            ...
                            $.ajax({
                                ...
                                success: function(data) {
                                    ...
                                    $dfd.resolve(data);
                                    var message =
                                        "<a href='#' class='notify-action'>Clear</a> Model added to Year succesfuly";
                                    var status = "success";
                                    var pos = "top-right";
                        ...
                        return $.Deferred(function($dfd) {
                            $.ajax({
                                ...
                                success: function(data) {
                                    $dfd.resolve(data);
                                    var message =
                                        "<a href='#' class='notify-action'>Clear</a> Model-Year Updated succesfuly";
                                    var status = "success";
                                    var pos = "top-right";
                                    showNotification(message, status, pos);
                        ...
                        return $.Deferred(function($dfd) {
                            $.ajax({
                                ...
                                success: function(data) {
                                    $dfd.resolve(data);
                                    var message =
                                        "<a href='#' class='notify-action'>Clear</a> Model Deleted from year succesfuly";
                                    var status = "success";
                                    var pos = "top-right";
                                    showNotification(message, status, pos);
