...
function scrollbarWidth() {
    var e = jQuery('<div style="width: 100%; height:200px;">test</div>'),
        a = jQuery('<div style="width:200px;height:150px; position: absolute; top: 0; left: 0; visibility: hidden; overflow:hidden;"></div>').append(e),
        i = e[0],
        e = a[0];
...
altair_page_onload = {
    ...
    card_progress: function (e, a, i) {
        ...
        t.each(function () {
            var e = $(this),
                t = a ? parseInt(a) : parseInt(e.attr("data-toolbar-progress")),
                n = e.attr("data-toolbar-progress-steps");
            if (i || n)
                if (t > 66) var s = "#dcedc8";
                else if (t > 33) var s = "#ffecb3";
                else var s = "#ffcdd2";
            else {
    ...
    hierarchical_slide: function () {
        ...
        e.length && e.each(function () {
            var e = $(this),
                a = e.attr("data-slide-children") ? e.children(e.attr("data-slide-children")) : e.children(),
                i = a.length,
    ...
    content_preloader_show: function (e, a, i, t, n) {
        if (!$body.find(".content-preloader").length) {
            var s = isHighDensity() ? "@2x" : "",
                t = t ? t : 48,
                n = n ? n : 48,
                r = "regular" == e ? '<img src="assets/img/spinners/spinner' + s + '.gif" alt="" width="32" height="32">' : '<div class="md-preloader"><svg xmlns="http://www.w3.org/2000/svg" version="1.1" height="' + n + '" width="' + t + '" viewbox="0 0 75 75"><circle cx="37.5" cy="37.5" r="33.5" stroke-width="8"/></svg></div>',
                d = "undefined" != typeof i ? $(i) : $body;
            d.append('<div class="content-preloader content-preloader-' + a + '" style="height:' + n + "px;width:" + t + "px;margin-left:-" + t / 2 + 'px">' + r + "</div>"), setTimeout(function () {
    ...
    color_picker: function (e, a, i) {
        if (e) {
            for (var t = randID_generator(), n = a ? a : ["#e53935", "#d81b60", "#8e24aa", "#5e35b1", "#3949ab", "#1e88e5", "#039be5", "#0097a7", "#00897b", "#43a047", "#689f38", "#ef6c00", "#f4511e", "#6d4c41", "#757575", "#546e7a"], s = n.length, r = $('<div class="cp_altair" id="' + t + '"/>'), d = 0; d < s; d++) {
                var o = "md-bg-" == n[d].substring(0, 6) ? "<span data-color=" + n[d] + ' class="' + n[d] + '"></span>' : "<span data-color=" + n[d] + ' style="background:' + n[d] + '"></span>';
                r.append(o)
            }
            return r.append('<input type="hidden">'), $body.on("click", "#" + t + " span", function () {
                $(this).addClass("active_color").siblings().removeClass("active_color").end().closest(".cp_altair").find("input").val($(this).attr("data-color")), "function" == typeof i && i.call(this)
            }), e.append(r)
        }
    },
